...
class BinaryTree
{
  ...
  public:
    ...
    bool isOrdered(Node* node, T min, T max) const;
    /**
    ...
    void printStuff(Node* node, stack<Node*>& nodes) const;
    void printStack(stack<Node*> nodes) const;
